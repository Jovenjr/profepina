...
const Navbar = () => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 bg-white z-50 transition-all duration-300 ${scrolled ? 'shadow-md' : ''}`}>
      <div className="relative container mx-auto px-4 pt-6 pb-3">
        {/* Logo centrado que sobresale */}
        <div className="absolute left-1/2 transform -translate-x-1/2 -top-2 md:-top-4 z-10">
